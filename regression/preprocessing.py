...
def build_parser():
    parser = argparse.ArgumentParser(description="Build processed PyG files from Davis/KIBA-style raw CSV files.")
    parser.add_argument(
        "--data_root",
        default=osp.join(osp.dirname(osp.abspath(__file__)), "data"),
        help="Root directory containing <dataset>/raw/data_train.csv and data_test.csv.",
    )
    parser.add_argument("--datasets", nargs="+", default=["davis", "kiba"], help="Dataset names to preprocess.")
    return parser
...
if __name__ == "__main__":
    ...
    for dataset_name in args.datasets:
        GNNDataset(osp.join(args.data_root, dataset_name))
